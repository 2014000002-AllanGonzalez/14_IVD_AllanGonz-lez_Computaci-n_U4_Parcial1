...
public class jfrmParcial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Duración del préstamo");
        ...
        jcbIncremento.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0.5", "0.25", "1.0", "1.5", "2.0" }));
        ...
        jtablaPrestamo.setAlignmentY(2.5F);
        ...
        jmnuPrestanoEn.setText("Préstamos en...");
        jmnuPrestanoEn.setToolTipText("");

        jmItemAños.setMnemonic('a');
        jmItemAños.setText("Años");
        jmItemAños.setToolTipText("");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfCredito, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    double incremento = Double.parseDouble(jcbIncremento.getSelectedItem().toString());
    ...
    private void jmItemAcercaDeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmItemAcercaDeActionPerformed
        ...
        JOptionPane.showMessageDialog(this,
                "Aplicacion Préstamo. Versión 1.0\n\n"
                + "Allan Fernando Federico González Flores IVD Clave:14");
    ...
    private void jbtCalculoAmortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCalculoAmortActionPerformed
        ...
        // Obtener los datos
        double monto = Double.parseDouble(jtfCredito.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfrmParcial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfrmParcial().setVisible(true);
            }
        });
    }
